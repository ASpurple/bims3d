...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:pn,depthTest:!1,depthWrite:!1})}function Ka(){return new On({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Br(),fragmentShader:`
		...
		`,blending:pn,depthTest:!1,depthWrite:!1})}function Ja(){return new On({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Br(),fragmentShader:`
